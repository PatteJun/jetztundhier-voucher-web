document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            paragraphElement.innerHTML = "Klicke nun auf den Weiter-Button, um den Kauf unserer PLUS-Version abzuschließen. Bitte gibt beim Kauf die E-Mail Adresse an, mit der du dich in der App registriert hast.<br /><br />Nach dem Kauf wird die PLUS-Version automatisch in der App freigeschaltet.";
